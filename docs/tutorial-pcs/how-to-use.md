...
2. Select the sound in the **Sound & Location** menu as you like to use.
   ...
   - The sound and locations are linked, unless you use the [custom position menu](./avatar-setup#custom-position) to override them.
...
| Image | Description |
|---|---|
| <img src={useBaseUrl('/img/menu/pcs-menu-mouth.png')} width="128" /> | <div><strong>Mouth</strong><br/>This menu is used to enable oral sounds. When activated, PCS will reposition itself to the mouth area.</div> |
| <img src={useBaseUrl('/img/menu/pcs-menu-boobs.png')} width="128" /> | <div><strong>Boobs</strong><br/>This menu is used to enable paizuri sounds. When activated, PCS will reposition itself to the boobs area.</div> |
| <img src={useBaseUrl('/img/menu/pcs-menu-pussy.png')} width="128" /> | <div><strong>Pussy</strong><br/>This menu is used to enable vaginal sounds. When activated, PCS will reposition itself to the pussy area.</div> |
| <img src={useBaseUrl('/img/menu/pcs-menu-ass.png')} width="128" /> | <div><strong>Ass</strong><br/>This menu is used to enable anal sounds. When activated, PCS will reposition itself to the ass area.</div> |
| <img src={useBaseUrl('/img/menu/pcs-menu-custom.png')} width="128" /> | <div><strong>Custom Position</strong><br/>This is a special menu called Custom Position. It overrides the default PCS position and replaces it with its own custom location — for example, the hand.</div> |
